...
**Solution** (<ins><a href="https://github.com/dmichaels/public/blob/master/work/code/cartera/project_sample/diagram.png">diagram</a></ins>)
...
- Beginning to end took about three months.
  - Long time due to new technology (Kafka), new SDLC processes, et.al.
...
- I updated backoffice dashboard UI (which I created - Node.js/Angular) with monitoring/reporting info (<a href="https://github.com/dmichaels/public/blob/master/work/code/cartera/project_sample/dig_dashboard.png">screenshot</a>).
...
- But got permission and access to a few isolated modules:
  - <a href="https://github.com/dmichaels/public/tree/master/work/code/cartera/project_sample/code_sample">Sample modules</a> (Java)
