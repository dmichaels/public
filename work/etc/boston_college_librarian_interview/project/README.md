...
**Solution** (<ins><a href="https://github.com/dmichaels/public/blob/master/work/etc/boston_college_librarian_interview/project/diagram.png">diagram</a></ins>)
...
- I updated backoffice dashboard UI (which I created - Node.js/Angular) with monitoring/reporting info (<a href="https://github.com/dmichaels/public/blob/master/work/etc/boston_college_librarian_interview/project/dig_dashboard.png">screenshot</a>).
