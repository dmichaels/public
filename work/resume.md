...
Implemented Linux PAM authentication module in C (with RPM/DEB packaging) for HYPR password-less authentication. Some authentication related backend work
